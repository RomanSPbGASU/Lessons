...
ptrn = compile(r"^(0[1-9]|1\d|2[0-8]|31(?=[./](0[13578]|1[02]))|(29|30)(?![./]02)|29(?=[./]02[./]([02468][048]|[13579][26])00)|29(?=[./]02[./]\d{2}([02468][048]|[13579][26]))(?![./]\d{2}[./](0[1-9]00|[1-9]\d00)))([.](?=\d{2}[.])|[/](?=\d{2}[/]))(?:0[1-9]|1[0-2])[./](?!0{4})\d{4}$")
